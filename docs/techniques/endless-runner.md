...
- **Sky Run** (flying-car power-up; `createFlightMode.js`, `models/createFlyingCarModel.js`): a rare `flycar` pickup appears in reward lines from 380 m, then every 900–1400 m (seeded). Collecting it switches to a Star Fox-style rail shooter:
